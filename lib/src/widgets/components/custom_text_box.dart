...
class _CustomTextBoxState extends State<CustomTextBox> {
  ...
  TextBoxState _currentState = TextBoxState.unselected;
  ...
  void _updateState() {
    ...
    if (!_isFocused && !hasText) {
      newState = TextBoxState.unselected;
    } else if (_isFocused && !hasText) {
      newState = TextBoxState.selected;
    } else if (_isFocused && hasText) {
      newState = TextBoxState.typing;
    } else {
      newState = TextBoxState.completed;
    }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.guideText != null || widget.maxLength != null) ...[
